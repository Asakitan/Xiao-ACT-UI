...
class SAOPlayerGUI(SAOPlayerGUIStateMixin, SAOPlayerGUISessionMixin):
    ...
    # ── State mixin (game-state pull + overlay push) moved to
    # gui_modules/sao_gui_state_mixin.py in round 32 of the
    # sao_gui split refactor. The methods
    #   _on_game_state_update / _apply_fast_state_update /
    #   _push_packet_overlays / _recognition_loop
    # all come from the SAOPlayerGUIStateMixin parent class.
