...
GUI_MODULES = [
    "gui_modules.sao_child_bar_gpu", "plugins.star_resonance_plugin.panels.sao_gui_actions_mixin",
    "plugins.star_resonance_plugin.panels.sao_gui_alert", "plugins.star_resonance_plugin.panels.sao_gui_autokey",
    "plugins.star_resonance_plugin.panels.sao_gui_bosshp", "plugins.star_resonance_plugin.panels.sao_gui_bossraid",
    "plugins.star_resonance_plugin.panels.sao_gui_buffmon", "plugins.star_resonance_plugin.panels.sao_gui_commander",
    "plugins.star_resonance_plugin.panels.sao_gui_damage_events_mixin", "gui_modules.sao_gui_dialogs_mixin",
    "plugins.star_resonance_plugin.panels.sao_gui_dps", "plugins.star_resonance_plugin.panels.sao_gui_dps_theme_mixin",
    "plugins.star_resonance_plugin.panels.sao_gui_engine_lifecycle_mixin", "plugins.star_resonance_plugin.panels.sao_gui_engine_toggles_mixin",
    "gui_modules.sao_gui_fisheye_mixin", "gui_modules.sao_gui_float_handlers_mixin",
    "gui_modules.sao_gui_float_hp_mixin", "plugins.star_resonance_plugin.panels.sao_gui_hp",
    ...
    "gui_modules.sao_gui_misc_mixin", "plugins.star_resonance_plugin.panels.sao_gui_packet_callbacks_mixin",
    "gui_modules.sao_gui_panel_fx_mixin", "gui_modules.sao_gui_panels_mixin",
    "plugins.star_resonance_plugin.panels.sao_gui_profile_editors", "plugins.star_resonance_plugin.entity_menu_bridge",
    "plugins.star_resonance_plugin.panels.sao_gui_skillfx", "plugins.star_resonance_plugin.panels.sao_gui_state_mixin",
    ...
    "gui_modules.sao_menu_hud", "gui_modules.sao_panel_ui",
