# -*- coding: utf-8 -*-
"""CS2 plugin — smooth Recoil Control System + auto-stop.
...
from .cs2_math import angle_to_pixels
...
class RCSState:
    ...
    def tick(self, local: Optional[dict]) -> Optional[Tuple[int, int]]:
        ...
        self._ema_p = alpha * raw_dp + (1.0 - alpha) * self._ema_p
        self._ema_y = alpha * raw_dy + (1.0 - alpha) * self._ema_y
