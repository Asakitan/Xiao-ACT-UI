...
- 当前版本：`4.6.86`（以 `config.py` 的 `APP_VERSION` 为准）
- 运行平台：Windows 10 / 11
...
```powershell
python build_delta.py --version 4.6.86 --files runtime/sao_gui.py web/menu.html
python build_full_package.py --version 4.6.86
