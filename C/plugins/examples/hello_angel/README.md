# hello_angel — AngelScript 历史 smoke fixture

这个fixture曾由已在2026-08-23删除的
`plugins/angel_host/tests/test_hello_angel.cpp`观察以下行为；当前不存在该测试入口：
...
它现在只保留为向后兼容的最小示例，不构成当前测试或live证据。
