...
// Facade calls acquire the GIL; JSON outputs use sao_plugins_pyhost_free_string.
...
extern "C" SAO_PLUGINS_API int32_t SAO_PLUGINS_CALL
sao_plugins_pyhost_module_get_json(py_plugin_handle_t plugin, const char* member_utf8,
                                   bool* out_callable, char** out_json_utf8, char** out_error_utf8);
...
extern "C" SAO_PLUGINS_API void* SAO_PLUGINS_CALL sao_plugins_pyhost_gil_scope_enter(void);
extern "C" SAO_PLUGINS_API void SAO_PLUGINS_CALL sao_plugins_pyhost_gil_scope_leave(void* scope);
