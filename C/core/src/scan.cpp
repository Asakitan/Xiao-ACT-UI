...
extern "C" int32_t SAO_CORE_CALL sao_core_scan_find_pattern(
...
extern "C" int32_t SAO_CORE_CALL sao_core_scan_find_aligned_u64(
    const uint8_t* haystack,
    size_t haystack_len,
    ...
    if (max_out_offsets >
        std::numeric_limits<size_t>::max() / sizeof(*out_offsets)) {
        return SAO_ERR_INVALID_ARGUMENT;
    }
