...
extern "C" SAO_LEGACY_CORE_API int32_t SAO_LEGACY_CORE_CALL sao_legacy_core_scan_find_pattern(
    const uint8_t* haystack, size_t haystack_len, const uint8_t* pattern, const uint8_t* mask,
    size_t pattern_len, size_t* out_offset);

extern "C" SAO_LEGACY_CORE_API int32_t SAO_LEGACY_CORE_CALL sao_legacy_core_scan_find_aligned_u64(
