...
sao_status_t sao_ui_handle_message(sao_platform_ctx* ctx,
                                   uint32_t message,
                                   uintptr_t w_param,
                                   intptr_t l_param,
                                   int32_t* out_handled);
...
struct sao_launcher_composition_test_hooks_t {
    ...
    sao_status_t (*plugins_discover)(sao_platform_ctx* ctx,
                                     sao_plugins_registry** registry_out,
                                     void* user_data);
    sao_status_t (*plugins_activate_autostart)(sao_plugins_registry* registry,
                                               void* user_data);
    sao_status_t (*plugins_shutdown)(sao_plugins_registry* registry,
                                     void* user_data);
    sao_status_t (*security_init)(const sao_security_config* cfg, void* user_data);
    void (*security_shutdown)(void* user_data);
    sao_status_t (*platform_bringup)(const sao_platform_config* cfg,
                                     sao_platform_ctx** ctx_out,
                                     void* user_data);
    ...
    sao_status_t (*ui_tick)(sao_platform_ctx* ctx, uint32_t elapsed_ms,
                            void* user_data);
    sao_status_t (*ui_handle_message)(sao_platform_ctx* ctx, uint32_t message,
                                      uintptr_t w_param, intptr_t l_param,
                                      int32_t* out_handled, void* user_data);
    void* user_data;
};

void sao_launcher_set_composition_test_hooks(
...
sao_status_t sao_launcher_init_pipeline_run(
    int argc,
    wchar_t** argv,
