...
- The user-specified `ZhuZiAYuanJWD.ttf` is copied unchanged from the existing project assets into the private native font resources and four HTML font directories; its identity and SHA-256 are recorded in `C/platform/ui/assets/fonts/SOURCE.md`.
