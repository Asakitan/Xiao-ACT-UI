...
inline bool widget_props_has_only(
...
sao_status_t apply_typed_widget_props(
    sao_ui_widget_handle_t handle, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;

sao_status_t restore_typed_widget_props(
    sao_ui_widget_handle_t handle, const WidgetPropsSnapshot& snapshot) noexcept;

sao_status_t paint_typed_widget(
    sao_ui_widget_handle_t handle, sao_ui_paint_ctx_handle_t context,
    int32_t x, int32_t y, int32_t width, int32_t height) noexcept;

sao_status_t widget_text_apply_props(
    sao_ui_widget_handle_t handle, int32_t kind, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;
sao_status_t widget_text_restore_props(
    sao_ui_widget_handle_t handle, int32_t kind,
    const WidgetPropsSnapshot& snapshot) noexcept;
sao_status_t widget_text_paint(
    sao_ui_widget_handle_t handle, int32_t kind,
    sao_ui_paint_ctx_handle_t context, int32_t x, int32_t y,
    int32_t width, int32_t height) noexcept;

sao_status_t widget_input_apply_props(
    sao_ui_widget_handle_t handle, int32_t kind, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;
sao_status_t widget_input_restore_props(
    sao_ui_widget_handle_t handle, int32_t kind,
    const WidgetPropsSnapshot& snapshot) noexcept;
sao_status_t widget_input_paint(
    sao_ui_widget_handle_t handle, int32_t kind,
    sao_ui_paint_ctx_handle_t context, int32_t x, int32_t y,
    int32_t width, int32_t height) noexcept;

sao_status_t widget_data_apply_props(
    sao_ui_widget_handle_t handle, int32_t kind, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;
sao_status_t widget_data_restore_props(
    sao_ui_widget_handle_t handle, int32_t kind,
    const WidgetPropsSnapshot& snapshot) noexcept;
sao_status_t widget_data_paint(
    sao_ui_widget_handle_t handle, int32_t kind,
    sao_ui_paint_ctx_handle_t context, int32_t x, int32_t y,
    int32_t width, int32_t height) noexcept;

sao_status_t widget_chart_apply_props(
    sao_ui_widget_handle_t handle, int32_t kind, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;
sao_status_t widget_chart_restore_props(
    sao_ui_widget_handle_t handle, int32_t kind,
    const WidgetPropsSnapshot& snapshot) noexcept;
sao_status_t widget_chart_paint(
    sao_ui_widget_handle_t handle, int32_t kind,
    sao_ui_paint_ctx_handle_t context, int32_t x, int32_t y,
    int32_t width, int32_t height) noexcept;

sao_status_t widget_table_apply_props(
    sao_ui_widget_handle_t handle, int32_t kind, const WidgetPropsJson& props,
    WidgetPropsSnapshot* out_snapshot) noexcept;
sao_status_t widget_table_restore_props(
    sao_ui_widget_handle_t handle, int32_t kind,
    const WidgetPropsSnapshot& snapshot) noexcept;
sao_status_t widget_table_paint(
    sao_ui_widget_handle_t handle, int32_t kind,
    sao_ui_paint_ctx_handle_t context, int32_t x, int32_t y,
    int32_t width, int32_t height) noexcept;
