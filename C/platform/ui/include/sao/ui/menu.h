...
// ── Lifecycle ─────────────────────────────────────────────────────
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_create(
    sao_ui_compositor_handle_t compositor,
    sao_ui_theme_handle_t theme,
    SaoUiMenuMode mode,
    sao_ui_menu_handle_t* out_handle);

SAO_UI_API void SAO_UI_CALL sao_ui_menu_destroy(
    sao_ui_menu_handle_t handle);

// ── Content ───────────────────────────────────────────────────────
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_set_items(
    sao_ui_menu_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_set_children(
    sao_ui_menu_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_set_layout(
    sao_ui_menu_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_show(
    sao_ui_menu_handle_t handle,
    int32_t anchor_x, int32_t anchor_y);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_hide(
    sao_ui_menu_handle_t handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_is_visible(
    sao_ui_menu_handle_t handle, bool* out_visible);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_get_phase(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_hit_test(
    sao_ui_menu_handle_t handle,
    int32_t x, int32_t y,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_set_hover(
    sao_ui_menu_handle_t handle, int32_t menu_idx);

// Trigger the same activation path that a mouse click would.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_activate(
    sao_ui_menu_handle_t handle, int32_t menu_idx);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_menu_query_hud_bounds(
    sao_ui_menu_handle_t handle,
