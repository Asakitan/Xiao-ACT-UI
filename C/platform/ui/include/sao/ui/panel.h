...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_create(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_spec(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_update_widget(
    sao_ui_panel_handle_t handle,
    const char* widget_id_utf8,
    const uint8_t* props_json_utf8,
    size_t props_len);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_visible(
    sao_ui_panel_handle_t handle, bool visible);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_position(
    sao_ui_panel_handle_t handle, int32_t x, int32_t y);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_geometry(
    sao_ui_panel_handle_t handle,
    int32_t x, int32_t y, int32_t width, int32_t height);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_get_layout_tree(
    sao_ui_panel_handle_t handle,
    sao_ui_layout_tree_handle_t* out_tree,
    sao_ui_layout_node_handle_t* out_root);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_rasterize(
    sao_ui_panel_handle_t handle,
    sao_ui_offscreen_raster_handle_t raster);

// Get the compositor layer id — used by tests / diagnostics.
SAO_UI_API sao_ui_layer_handle_t SAO_UI_CALL sao_ui_panel_layer(
    sao_ui_panel_handle_t handle);

// Panel action callback — fired when the user clicks a widget marked
// with `action` in the UI spec.
typedef void (SAO_UI_CALL* sao_ui_panel_action_callback_t)(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_action_handler(
    sao_ui_panel_handle_t handle,
    sao_ui_panel_action_callback_t callback,
    void* user_data);

// Panel lifecycle event callback.
typedef void (SAO_UI_CALL* sao_ui_panel_event_callback_t)(
    int32_t event_kind,           // sao_ui_panel_event_e
    void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_event_handler(
    sao_ui_panel_handle_t handle,
    sao_ui_panel_event_callback_t callback,
    void* user_data);
...
typedef void (SAO_UI_CALL* sao_ui_panel_render_fn_t)(
    void* paint_ctx,
    float x, float y, float width, float height,
    void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_render_fn(
    sao_ui_panel_handle_t handle,
    sao_ui_panel_render_fn_t fn, void* user_data);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_get_state(
    sao_ui_panel_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_find_by_id(
    sao_ui_compositor_handle_t compositor,
    const char* panel_id_utf8,
    sao_ui_panel_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_enumerate(
    sao_ui_compositor_handle_t compositor,
