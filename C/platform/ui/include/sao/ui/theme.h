...
inline constexpr SaoColorRgba kSaoThemeDarkColors[SAO_UI_COLOR_TOKEN_COUNT] = {
    /* [ 0] OVERLAY_BG          */ rgba(0x19, 0x1B, 0x20, 0xB3),
    /* [ 1] APP_BG              */ rgba(0x19, 0x1B, 0x20),
    /* [ 2] APP_CARD            */ rgba(0x24, 0x28, 0x30),
    /* [ 3] APP_BORDER          */ rgba(0x35, 0x3B, 0x46),
    /* [ 4] APP_TEXT            */ rgba(0xEC, 0xEF, 0xF5),
    /* [ 5] APP_TEXT_2          */ rgba(0xB7, 0xBF, 0xCC),
    /* [ 6] APP_TEXT_DIM        */ rgba(0x91, 0x9C, 0xAE),
    /* [ 7] APP_ACCENT          */ rgba(0xD7, 0xAD, 0x72),
    ...
    /* [13] CIRCLE_BORDER       */ rgba(0x49, 0x53, 0x65),
    /* [14] CIRCLE_BG           */ rgba(0x24, 0x28, 0x30),
    /* [15] CIRCLE_ICON         */ rgba(0xD4, 0xDA, 0xE6),
    ...
    /* [21] CHILD_BG            */ rgba(0x24, 0x28, 0x30),
    /* [22] CHILD_HOVER         */ rgba(0x39, 0x36, 0x2F),
    /* [23] CHILD_HOVER_FG      */ rgba(0xEE, 0xF0, 0xE8),
    /* [24] CHILD_TEXT          */ rgba(0xEC, 0xEF, 0xF5),
    /* [25] CHILD_LINE          */ rgba(0x35, 0x3B, 0x46),
    /* [26] CHILD_ICON          */ rgba(0xB7, 0xBF, 0xCC),
    /* [27] INFO_BG             */ rgba(0x24, 0x28, 0x30),
    /* [28] INFO_BOTTOM         */ rgba(0x20, 0x22, 0x28),
    /* [29] INFO_TITLE_BORDER   */ rgba(0x35, 0x3B, 0x46),
    /* [30] INFO_TRIANGLE       */ rgba(0x24, 0x28, 0x30),
    /* [31] ALERT_BG            */ rgba(0x19, 0x1B, 0x20),
    /* [32] ALERT_PANEL         */ rgba(0x24, 0x28, 0x30),
    /* [33] ALERT_TITLE_FG      */ rgba(0xEC, 0xEF, 0xF5),
    /* [34] ALERT_CONTENT_FG    */ rgba(0xB7, 0xBF, 0xCC),
    ...
    /* [51] SURFACE_LIGHT       */ rgba(0x24, 0x28, 0x30),
    /* [52] TEXT_PRIMARY        */ rgba(0xEC, 0xEF, 0xF5),
    /* [53] TEXT_SECONDARY      */ rgba(0x91, 0x9C, 0xAE),
    ...
    /* [75] DISABLED_FG         */ rgba(0x77, 0x81, 0x91),
    /* [76] DISABLED_BG         */ rgba(0x20, 0x23, 0x2A),
    /* [77] DISABLED_BORDER     */ rgba(0x30, 0x36, 0x40),
    /* [78] HOVER_SURFACE       */ rgba(0x2D, 0x33, 0x3F),
    /* [79] FOCUS_RING          */ rgba(0xED, 0xB4, 0x5B),
    /* [80] PRESSED_SURFACE     */ rgba(0x37, 0x3F, 0x4E),
    /* [81] PLACEHOLDER         */ rgba(0x7E, 0x89, 0x9B),
    /* [82] SELECTION           */ rgba(0x36, 0x4A, 0x67),
    /* [83] SCROLLBAR_TRACK     */ rgba(0x19, 0x1B, 0x20, 0x00),
    /* [84] SCROLLBAR_THUMB     */ rgba(0x4A, 0x52, 0x61),
    /* [85] SCROLLBAR_HOVER     */ rgba(0x70, 0x7A, 0x8C),
    /* [86] SCROLLBAR_PRESSED   */ rgba(0xED, 0xB4, 0x5B),
    /* [87] TOOLTIP_SURFACE     */ rgba(0x24, 0x28, 0x30),
...
inline constexpr SaoColorRgba kSaoThemeLightColors[SAO_UI_COLOR_TOKEN_COUNT] = {
    /* [ 0] OVERLAY_BG          */ rgba(0x1C, 0x24, 0x32, 0xA0),
    /* [ 1] APP_BG              */ rgba(0xF4, 0xF6, 0xF9),
    /* [ 2] APP_CARD            */ rgba(0xFF, 0xFF, 0xFF),
    /* [ 3] APP_BORDER          */ rgba(0xDF, 0xE5, 0xEE),
    /* [ 4] APP_TEXT            */ rgba(0x22, 0x2B, 0x39),
    /* [ 5] APP_TEXT_2          */ rgba(0x68, 0x75, 0x87),
    /* [ 6] APP_TEXT_DIM        */ rgba(0x80, 0x8C, 0x9D),
    /* [ 7] APP_ACCENT          */ rgba(0x9B, 0x63, 0x22),
    ...
    /* [13] CIRCLE_BORDER       */ rgba(0xD7, 0xDF, 0xEB),
    /* [14] CIRCLE_BG           */ rgba(0xFF, 0xFF, 0xFF),
    /* [15] CIRCLE_ICON         */ rgba(0x56, 0x65, 0x79),
    ...
    /* [21] CHILD_BG            */ rgba(0xFF, 0xFF, 0xFF),
    /* [22] CHILD_HOVER         */ rgba(0xF2, 0xE3, 0xCE),
    /* [23] CHILD_HOVER_FG      */ rgba(0x23, 0x27, 0x24),
    /* [24] CHILD_TEXT          */ rgba(0x22, 0x2B, 0x39),
    /* [25] CHILD_LINE          */ rgba(0xDF, 0xE5, 0xEE),
    /* [26] CHILD_ICON          */ rgba(0x68, 0x75, 0x87),
    /* [27] INFO_BG             */ rgba(0xFF, 0xFF, 0xFF),
    /* [28] INFO_BOTTOM         */ rgba(0xF4, 0xF6, 0xF9),
    /* [29] INFO_TITLE_BORDER   */ rgba(0xDF, 0xE5, 0xEE),
    /* [30] INFO_TRIANGLE       */ rgba(0xFF, 0xFF, 0xFF),
    /* [31] ALERT_BG            */ rgba(0xF4, 0xF6, 0xF9),
    /* [32] ALERT_PANEL         */ rgba(0xFF, 0xFF, 0xFF),
    /* [33] ALERT_TITLE_FG      */ rgba(0x22, 0x2B, 0x39),
    /* [34] ALERT_CONTENT_FG    */ rgba(0x68, 0x75, 0x87),
    ...
    /* [49] BOSS_HP_BREAK       */ rgba(0xD4, 0x9C, 0x17),
    /* [50] BOSS_HP_SHIELD      */ rgba(0x48, 0x9C, 0xE8, 0x6B),
    /* [51] SURFACE_LIGHT       */ rgba(0xFF, 0xFF, 0xFF),
    /* [52] TEXT_PRIMARY        */ rgba(0x22, 0x2B, 0x39),
    /* [53] TEXT_SECONDARY      */ rgba(0x68, 0x75, 0x87),
    ...
    /* [73] ELEM_DARK           */ rgba(0x9B, 0x6B, 0xD6),
    /* [74] ELEM_GENERIC        */ rgba(0xB0, 0xB8, 0xC4),
    /* [75] DISABLED_FG         */ rgba(0x8A, 0x94, 0xA4),
    /* [76] DISABLED_BG         */ rgba(0xF0, 0xF2, 0xF6),
    /* [77] DISABLED_BORDER     */ rgba(0xE2, 0xE7, 0xEF),
    /* [78] HOVER_SURFACE       */ rgba(0xED, 0xF1, 0xF7),
    /* [79] FOCUS_RING          */ rgba(0xD9, 0x95, 0x36),
    /* [80] PRESSED_SURFACE     */ rgba(0xE2, 0xE8, 0xF1),
    /* [81] PLACEHOLDER         */ rgba(0x88, 0x93, 0xA3),
    /* [82] SELECTION           */ rgba(0xDC, 0xE7, 0xF5),
    /* [83] SCROLLBAR_TRACK     */ rgba(0xF4, 0xF6, 0xF9, 0x00),
    /* [84] SCROLLBAR_THUMB     */ rgba(0xC6, 0xCE, 0xDB),
    /* [85] SCROLLBAR_HOVER     */ rgba(0x9B, 0xA7, 0xB9),
    /* [86] SCROLLBAR_PRESSED   */ rgba(0xD9, 0x95, 0x36),
    /* [87] TOOLTIP_SURFACE     */ rgba(0xFF, 0xFF, 0xFF),
...
inline constexpr SaoColorRgba kSaoThemeGlassColors[SAO_UI_COLOR_TOKEN_COUNT] = {
    /* [ 0] OVERLAY_BG          */ rgba(0x1C, 0x24, 0x32, 0x99),
    /* [ 1] APP_BG              */ rgba(0xF4, 0xF6, 0xF9, 0xEB),
    /* [ 2] APP_CARD            */ rgba(0xFF, 0xFF, 0xFF, 0xEB),
    /* [ 3] APP_BORDER          */ rgba(0xDF, 0xE5, 0xEE),
    /* [ 4] APP_TEXT            */ rgba(0x22, 0x2B, 0x39),
    /* [ 5] APP_TEXT_2          */ rgba(0x68, 0x75, 0x87),
    /* [ 6] APP_TEXT_DIM        */ rgba(0x80, 0x8C, 0x9D),
    ...
    /* [12] APP_GOLD            */ rgba(0x96, 0x61, 0x1F),
    /* [13] CIRCLE_BORDER       */ rgba(0xD7, 0xDF, 0xEB),
    /* [14] CIRCLE_BG           */ rgba(0xFF, 0xFF, 0xFF, 0xF0),
    /* [15] CIRCLE_ICON         */ rgba(0x56, 0x65, 0x79),
    /* [16] CIRCLE_ACTIVE_BORDER*/ rgba(0xD9, 0x95, 0x36),
    /* [17] CIRCLE_ACTIVE_BG    */ rgba(0xD9, 0x95, 0x36),
    /* [18] CIRCLE_ACTIVE_ICON  */ rgba(0x23, 0x27, 0x24),
    ...
    /* [20] CIRCLE_HOVER_ICON   */ rgba(0x6C, 0x4B, 0x22),
    /* [21] CHILD_BG            */ rgba(0xFF, 0xFF, 0xFF, 0xF0),
    /* [22] CHILD_HOVER         */ rgba(0xF2, 0xE3, 0xCE, 0xF0),
    /* [23] CHILD_HOVER_FG      */ rgba(0x23, 0x27, 0x24),
    /* [24] CHILD_TEXT          */ rgba(0x23, 0x27, 0x24),
    /* [25] CHILD_LINE          */ rgba(0xDF, 0xE5, 0xEE),
    /* [26] CHILD_ICON          */ rgba(0x64, 0x6A, 0x65),
    /* [27] INFO_BG             */ rgba(0xFF, 0xFF, 0xFF, 0xEB),
    /* [28] INFO_BOTTOM         */ rgba(0xF4, 0xF6, 0xF9, 0xEB),
    /* [29] INFO_TITLE_BORDER   */ rgba(0xDF, 0xE5, 0xEE),
    /* [30] INFO_TRIANGLE       */ rgba(0xFF, 0xFF, 0xFF, 0xEB),
    /* [31] ALERT_BG            */ rgba(0xF4, 0xF6, 0xF9, 0xEB),
    /* [32] ALERT_PANEL         */ rgba(0xFF, 0xFF, 0xFF, 0xEB),
    ...
    /* [51] SURFACE_LIGHT       */ rgba(0xFF, 0xFF, 0xFF, 0x50),
    /* [52] TEXT_PRIMARY        */ rgba(0x22, 0x2B, 0x39),
    /* [53] TEXT_SECONDARY      */ rgba(0x68, 0x75, 0x87),
    /* [54] ACCENT_GOLD_WARM    */ rgba(0xD9, 0x95, 0x36),
    /* [55] ACCENT_CYAN_SOFT    */ rgba(0x9A, 0x9F, 0x99),
    ...
    /* [78] HOVER_SURFACE       */ rgba(0xED, 0xF1, 0xF7, 0xF0),
    /* [79] FOCUS_RING          */ rgba(0xD9, 0x95, 0x36),
    /* [80] PRESSED_SURFACE     */ rgba(0xE2, 0xE8, 0xF1, 0xF0),
...
inline constexpr int32_t kSaoThemeMetrics[SAO_UI_METRIC_TOKEN_COUNT] = {
    /* [ 0] BORDER_RADIUS_SMALL   */ 6,
    /* [ 1] BORDER_RADIUS_MEDIUM  */ 8,
    /* [ 2] BORDER_RADIUS_LARGE   */ 12,
    /* [ 3] PADDING_XS            */ 2,
    /* [ 4] PADDING_S             */ 4,
    /* [ 5] PADDING_M             */ 16,
    /* [ 6] PADDING_L             */ 20,
