...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_table_create(void* d3d_device_ptr,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_table_set_rows(sao_ui_widget_handle_t handle,
                                                          const SaoUiTableRow* rows,
                                                          size_t row_count);

// Add or update a single row by row_id.  Missing → insert.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_table_upsert_row(sao_ui_widget_handle_t handle,
                                                            const SaoUiTableRow* row);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_table_remove_row(sao_ui_widget_handle_t handle,
                                                            int64_t row_id);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_table_clear_rows(sao_ui_widget_handle_t handle);

SAO_UI_API sao_status_t SAO_UI_CALL
sao_ui_table_set_sort(sao_ui_widget_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_widget_table_update_pointer_state(
...
typedef void(SAO_UI_CALL* sao_ui_table_row_click_cb_t)(int64_t row_id, void* user_data);
...
typedef void(SAO_UI_CALL* sao_ui_table_cell_action_cb_t)(int64_t row_id,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_tree_view_create(void* d3d_device_ptr,
                                                            const SaoUiTreeViewSpec* spec,
                                                            sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_tree_view_set_nodes(sao_ui_widget_handle_t handle,
                                                               const SaoUiTreeNode* nodes,
                                                               size_t node_count);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_tree_view_expand_node(sao_ui_widget_handle_t handle,
                                                                 int64_t node_id, bool expanded);

typedef void(SAO_UI_CALL* sao_ui_tree_select_cb_t)(int64_t node_id, void* user_data);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_tree_view_select_node(sao_ui_widget_handle_t handle,
                                                                 int64_t node_id);

SAO_UI_API sao_status_t SAO_UI_CALL
sao_ui_tree_view_get_visible_count(sao_ui_widget_handle_t handle, size_t* out_count);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_tree_view_get_visible_node(sao_ui_widget_handle_t handle,
