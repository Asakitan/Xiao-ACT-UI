...
SAO_UI_API const SaoUiLinkStartTimeline* SAO_UI_CALL sao_ui_nervegear_default_timeline(void);
...
typedef void(SAO_UI_CALL* sao_ui_nervegear_event_callback_t)(
    SaoUiNerveGearEvent event, int32_t x, int32_t y, // screen coords at event time
    void* user_data);

// ── Lifecycle ─────────────────────────────────────────────────────
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_create(sao_ui_compositor_handle_t compositor,
...
SAO_UI_API void SAO_UI_CALL sao_ui_nervegear_destroy(sao_ui_nervegear_handle_t handle);

// ── Visibility / z-order ──────────────────────────────────────────
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_show(sao_ui_nervegear_handle_t handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_hide(sao_ui_nervegear_handle_t handle);
...
// ── Position + palette ────────────────────────────────────────────
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_set_position(sao_ui_nervegear_handle_t handle,
                                                                  int32_t x, int32_t y);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_get_position(sao_ui_nervegear_handle_t handle,
                                                                  int32_t* out_x, int32_t* out_y);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_set_palette(sao_ui_nervegear_handle_t handle,
                                                                 SaoUiNerveGearPalette palette);

// ── State transitions ─────────────────────────────────────────────
// Read-only view of the current state.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_get_state(sao_ui_nervegear_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_transition(sao_ui_nervegear_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_set_alpha(sao_ui_nervegear_handle_t handle,
                                                               float alpha);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_nervegear_get_hit_shape(sao_ui_nervegear_handle_t handle,
