...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_register(sao_ui_compositor_handle_t compositor,
                                                          const SaoPanelDescriptor* descriptor,
                                                          sao_ui_panel_handle_t* out_panel,
                                                          sao_ui_panel_body_handle_t* out_body);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_unregister(sao_ui_panel_handle_t panel);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_get_descriptor(sao_ui_panel_handle_t panel,
                                                                SaoPanelDescriptor* descriptor_out);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_registry_count(size_t* count_out);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_update_body(sao_ui_panel_body_handle_t body,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_body_set_spec(sao_ui_panel_body_handle_t body,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_show(sao_ui_panel_handle_t panel);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_hide(sao_ui_panel_handle_t panel);

// Raise the panel above its z-class siblings.  Never crosses classes.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_bring_to_front(sao_ui_panel_handle_t panel);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_send_to_back(sao_ui_panel_handle_t panel);

// Opacity control (0..1).  DPS default 0.93; BossHP fixed 1.0.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_set_opacity(sao_ui_panel_handle_t panel,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_panel_clear_theme_override(sao_ui_panel_handle_t panel);
...
typedef void(SAO_UI_CALL* sao_ui_panel_geometry_cb_t)(const char* panel_id_utf8, int32_t x,
