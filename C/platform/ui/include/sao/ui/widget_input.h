...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_create(
    void* d3d_device_ptr,
    const SaoUiButtonSpec* spec,
    sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_update(
    sao_ui_widget_handle_t handle,
    const SaoUiButtonSpec* spec);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_set_text(
    sao_ui_widget_handle_t handle,
    const char* text_utf8);

// Toggle between the pre-styled 'active' and normal appearance.  Mirrors
// _RoundedButton.set_active().
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_set_active(
    sao_ui_widget_handle_t handle, bool active);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_set_disabled(
    sao_ui_widget_handle_t handle, bool disabled);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_button_set_click_handler(
    sao_ui_widget_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_icon_button_create(
    void* d3d_device_ptr,
...
typedef void (SAO_UI_CALL* sao_ui_dropdown_pick_cb_t)(
    int32_t item_id, void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_dropdown_button_create(
    void* d3d_device_ptr,
    const SaoUiDropdownButtonSpec* spec,
    sao_ui_widget_handle_t* out_handle);
...
typedef void (SAO_UI_CALL* sao_ui_toggle_cb_t)(
    bool checked, void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_checkbox_create(
    void* d3d_device_ptr,
    const SaoUiCheckboxSpec* spec,
    sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_checkbox_set_checked(
    sao_ui_widget_handle_t handle, bool checked);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_checkbox_set_toggle_handler(
    sao_ui_widget_handle_t handle,
    sao_ui_toggle_cb_t callback,
    void* user_data);
...
typedef void (SAO_UI_CALL* sao_ui_radio_pick_cb_t)(
    int32_t group_id, int32_t value_id, void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_radio_create(
    void* d3d_device_ptr,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_radio_set_group_pick_handler(
    sao_ui_widget_handle_t handle,
    sao_ui_radio_pick_cb_t callback,
    void* user_data);
...
typedef void (SAO_UI_CALL* sao_ui_slider_change_cb_t)(
    float new_value, void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_slider_create(
    void* d3d_device_ptr,
    const SaoUiSliderSpec* spec,
    sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_slider_set_value(
    sao_ui_widget_handle_t handle, float value);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_slider_set_change_handler(
    sao_ui_widget_handle_t handle,
    sao_ui_slider_change_cb_t callback,
    void* user_data);
