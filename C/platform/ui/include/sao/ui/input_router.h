...
SAO_UI_API void SAO_UI_CALL sao_ui_input_router_deep_destroy(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_feed_raw_win32(
    sao_ui_input_router_deep_handle_t handle,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_set_panel_region(
    sao_ui_input_router_deep_handle_t handle,
    sao_ui_panel_handle_t panel,
    const SaoUiHitRegion* region);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_focus_next(
    sao_ui_input_router_deep_handle_t handle,
    bool reverse);                          // Shift+Tab semantics

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_get_focus(
    sao_ui_input_router_deep_handle_t handle,
    sao_ui_widget_handle_t* out_widget,
    sao_ui_panel_handle_t*  out_panel);

// Push a modal barrier for the given panel.  Focus can't move outside
// this panel until the barrier is popped (typically on panel close).
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_push_modal(
    sao_ui_input_router_deep_handle_t handle,
    sao_ui_panel_handle_t panel);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_pop_modal(
    sao_ui_input_router_deep_handle_t handle);
...
typedef void (SAO_UI_CALL* sao_ui_hover_change_cb_t)(
    sao_ui_widget_handle_t previous_widget,
    sao_ui_widget_handle_t current_widget,
    void* user_data);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_set_hover_change_handler(
    sao_ui_input_router_deep_handle_t handle,
    sao_ui_hover_change_cb_t callback,
    void* user_data);
...
typedef void (SAO_UI_CALL* sao_ui_hotkey_cb_t)(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_input_router_release_mouse(
    sao_ui_input_router_deep_handle_t handle);
