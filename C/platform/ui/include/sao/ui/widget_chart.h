...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_time_series_chart_append(sao_ui_widget_handle_t handle,
                                                                    const char* lane_id_utf8,
                                                                    const SaoUiTimePoint* points,
                                                                    size_t point_count);

SAO_UI_API sao_status_t SAO_UI_CALL
sao_ui_time_series_chart_set_zoom(sao_ui_widget_handle_t handle,
...
// Streaming helpers are part of the production header.  Every operation is
// serialized with lane replacement/capacity changes.  Capacity 0 restores the
// value from max_visible_points (or the implementation default).
SAO_UI_API sao_status_t SAO_UI_CALL
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_widget_timeseries_clear(sao_ui_widget_handle_t handle);

SAO_UI_API sao_status_t SAO_UI_CALL
sao_ui_widget_timeseries_compute_axis(sao_ui_widget_handle_t handle, SaoUiTimeSeriesAxis* out_axis);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_bar_chart_create(void* d3d_device_ptr,
                                                            const SaoUiBarChartSpec* spec,
                                                            sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_bar_chart_set_bars(sao_ui_widget_handle_t handle,
                                                              const SaoUiBarChartBar* bars,
                                                              size_t bar_count);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_bar_chart_get_bar_count(sao_ui_widget_handle_t handle,
                                                                   size_t* out_count,
                                                                   size_t* out_hidden_count);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_bar_chart_get_bar(sao_ui_widget_handle_t handle,
                                                             size_t index,
                                                             SaoUiBarChartBar* out_bar);

// Copies label_utf8 into caller storage and points out_bar->label_utf8 at that
// storage.  out_label_required includes the trailing NUL.  The legacy get_bar
// remains ABI-compatible and returns a thread-local owned label snapshot valid
// until the next get_bar call on the same thread.
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_bar_chart_get_bar_copy(
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_line_chart_create(void* d3d_device_ptr,
                                                             const SaoUiLineChartSpec* spec,
                                                             sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_line_chart_set_series(sao_ui_widget_handle_t handle,
                                                                 const SaoUiLineChartSeries* series,
                                                                 size_t series_count);
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_line_chart_get_point(sao_ui_widget_handle_t handle,
                                                                size_t series_index,
                                                                size_t point_index,
...
SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_sparkline_create(void* d3d_device_ptr,
                                                            const SaoUiSparklineSpec* spec,
                                                            sao_ui_widget_handle_t* out_handle);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_sparkline_set_values(sao_ui_widget_handle_t handle,
                                                                const double* values,
                                                                size_t value_count);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_sparkline_append(sao_ui_widget_handle_t handle,
                                                            double value);

SAO_UI_API sao_status_t SAO_UI_CALL sao_ui_sparkline_get_range(sao_ui_widget_handle_t handle,
