...
TEST_CASE("router_dispatch_mouse_to_focus_target", "[ui][input_router][wave4]") {
    sao_ui_input_router_deep_handle_t router = nullptr;
...
TEST_CASE("router_push_pop_focus_maintains_stack", "[ui][input_router][wave4]") {
    sao_ui_input_router_deep_handle_t router = nullptr;
    REQUIRE(sao_ui_input_router_deep_create(nullptr, &router) == SAO_STATUS_OK);
...
TEST_CASE("router_hotkey_subset_match_most_specific", "[ui][input_router][wave4]") {
...
TEST_CASE("router_modal_barrier_blocks_others", "[ui][input_router][wave4]") {
    sao_ui_input_router_deep_handle_t router = nullptr;
    REQUIRE(sao_ui_input_router_deep_create(nullptr, &router) == SAO_STATUS_OK);
