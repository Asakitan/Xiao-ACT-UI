// SAO Auto — Wave3 animator curve + scheduler tests (G3.7 gate).
//
...
TEST_CASE("animator_curve_linear_endpoints", "[ui][animator][wave3]") {
...
TEST_CASE("animator_curve_ease_in_starts_slow", "[ui][animator][wave3]") {
...
TEST_CASE("animator_curve_ease_out_ends_slow", "[ui][animator][wave3]") {
...
TEST_CASE("animator_curve_ease_in_out_symmetric", "[ui][animator][wave3]") {
...
TEST_CASE("animator_curve_bounce_bounces_multiple_times", "[ui][animator][wave3]") {
...
TEST_CASE("animator_add_animation_and_tick_reaches_target", "[ui][animator][wave3]") {
...
TEST_CASE("animator_animation_on_complete_fires", "[ui][animator][wave3]") {
    sao_ui_animator_handle_t h = nullptr;
    REQUIRE(sao_ui_animator_create(&h) == SAO_STATUS_OK);
    DoneOnly ctx;
    SaoUiAnimationSpec spec{};
