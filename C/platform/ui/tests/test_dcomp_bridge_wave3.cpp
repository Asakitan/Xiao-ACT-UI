// Wave 3 tests for the dcomp_bridge first-implementable slice.
//
// Coverage:
...
// rather than fail, because the wave3 slice is validating COM lifetime
...
TEST_CASE("dcomp_bridge_d3d11_device_nonnull",
    ...
    // Wave 15.2 wires CreateSwapChainForComposition before the visual
...
TEST_CASE("dcomp_bridge_only_on_windows", "[ui][dcomp_bridge][wave3]") {
