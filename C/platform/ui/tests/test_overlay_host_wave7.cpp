// Wave 7 tests for the overlay_host additional WM_ handler slice.
//
...
//     (fixture-parity anchor — uses W5b's topmost_race_deterministic
...
SaoOverlayHostConfig make_default_config() {
    ...
    cfg.origin_x    = 0;
    cfg.origin_y    = 0;
    cfg.title_utf16 = L"SAO Overlay Host [wave7 test]";
...
// Fixture-parity helper (borrowed from test_subpixel_wave6.cpp).  Walks
...
TEST_CASE("overlay_host_wave7_windows_only",
          "[ui][overlay_host][wave7]") {
    SUCCEED("overlay_host Wave 7 is Windows-only");
}
