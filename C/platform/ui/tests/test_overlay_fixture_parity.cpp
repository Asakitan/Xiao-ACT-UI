// Overlay compositor fixture parity against the frozen Python state machine.
//
...
TEST_CASE("fixture parity overlay normal_add_show_reorder",
          "[ui][overlay][fixture][lifecycle]") {
    verify_overlay_fixture("normal_add_show_reorder.json");
}

TEST_CASE("fixture parity overlay topmost_race_deterministic",
          "[ui][overlay][fixture][lifecycle]") {
    verify_overlay_fixture("topmost_race_deterministic.json");
}

TEST_CASE("fixture parity overlay gdi_leak_scenario_destroy_and_recreate",
          "[ui][overlay][fixture][lifecycle]") {
    verify_overlay_fixture("gdi_leak_scenario_destroy_and_recreate.json");
}

TEST_CASE("fixture parity overlay focus_shield_edge_click_through_false",
          "[ui][overlay][fixture][lifecycle]") {
    verify_overlay_fixture("focus_shield_edge_click_through_false.json");
}

TEST_CASE("fixture parity overlay present_tick_normal_dirty_flag",
          "[ui][overlay][fixture][lifecycle]") {
    verify_overlay_fixture("present_tick_normal_dirty_flag.json");
}

TEST_CASE("fixture parity overlay z_order_tie_by_insertion",
          "[ui][overlay][fixture][lifecycle]") {
