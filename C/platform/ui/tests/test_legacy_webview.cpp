// Tests for the frozen legacy_webview compatibility
...
TEST_CASE("legacy_webview_probe_python_side", "[ui][legacy_webview][real_plugins]") {
...
TEST_CASE("legacy_webview_manifest_exists", "[ui][legacy_webview][real_plugins]") {
