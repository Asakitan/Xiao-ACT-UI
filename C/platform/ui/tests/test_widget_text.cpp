// Label widget state and measurement tests.
//
// Coverage (5 CASE):
...
TEST_CASE("label_create_stores_spec_and_text", "[ui][widget][text][runtime]") {
...
TEST_CASE("label_set_text_updates_measure_dirty", "[ui][widget][text][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
...
TEST_CASE("label_measure_single_line_ascii", "[ui][widget][text][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
...
TEST_CASE("label_measure_wrap_multi_line", "[ui][widget][text][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
