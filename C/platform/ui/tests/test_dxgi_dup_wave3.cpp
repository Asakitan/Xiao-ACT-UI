// Wave 3 tests for the dxgi_dup first-implementable slice.
//
// Coverage:
...
// because the wave3 slice is validating the protocol wiring, not the
...
TEST_CASE("dxgi_dup_only_on_windows", "[ui][dxgi_dup][wave3]") {
