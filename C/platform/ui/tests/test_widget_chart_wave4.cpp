...
TEST_CASE("timeseries_push_and_get_returns_chronological", "[ui][widget][chart][wave4]") {
...
TEST_CASE("timeseries_ring_buffer_wraps_after_capacity", "[ui][widget][chart][wave4]") {
...
TEST_CASE("timeseries_clear_resets_all_lanes", "[ui][widget][chart][wave4]") {
...
TEST_CASE("timeseries_compute_axis_returns_min_max", "[ui][widget][chart][wave4]") {
    sao_ui_widget_handle_t h = make_chart_with_single_lane(16);
