...
# Generates Python-authority render fixtures for the production C++
...
def render_skillfx() -> None:
    ...
    gl_metadata_path = FIXTURE_DIR / "skillfx_sdf_gl.json"
    try:
    ...
    if sdf_frame is None:
        ...
        (FIXTURE_DIR / "skillfx_sdf_gl.bgra").unlink(missing_ok=True)
