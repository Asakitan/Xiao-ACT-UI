...
output = fixture_dir / "wave15_nervegear_hover.bgra"
...
(fixture_dir / "wave15_nervegear_hover.json").write_text(
...
popup_output = fixture_dir / "wave15_popup.bgra"
...
(fixture_dir / "wave15_popup.json").write_text(
