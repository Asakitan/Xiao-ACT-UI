// Tests for reentrant render_capture_sync depth and wait behavior.
//
...
TEST_CASE("capture_sync_begin_end_depth", "[ui][capture_sync][automation]") {
    drain_capture_state();
...
TEST_CASE("capture_sync_wait_idle_timeout", "[ui][capture_sync][automation]") {
    drain_capture_state();
