// NerveGear state-machine, hit-test, timeline, and callback tests.
//
// Coverage (8 CASE):
...
// ── Prototypes for helper APIs implemented in nervegear.cpp
...
TEST_CASE("nervegear_starts_idle", "[ui][nervegear][interpreter]") {
...
TEST_CASE("nervegear_hover_on_mouse_enter", "[ui][nervegear][interpreter]") {
    sao_ui_nervegear_handle_t btn = make_button();
...
TEST_CASE("nervegear_press_release_starts_linking", "[ui][nervegear][interpreter]") {
    sao_ui_nervegear_handle_t btn = make_button();
...
TEST_CASE("nervegear_hit_test_inside_circle", "[ui][nervegear][interpreter]") {
    sao_ui_nervegear_handle_t btn = make_button();
...
TEST_CASE("nervegear_hit_test_outside_circle_misses", "[ui][nervegear][interpreter]") {
    sao_ui_nervegear_handle_t btn = make_button();
