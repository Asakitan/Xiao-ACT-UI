// SAO Auto — Wave3 panel_layout tests (G3.9 gate).
//
...
TEST_CASE("layout_vertical_distributes_weight_equally", "[ui][layout][wave3]") {
...
TEST_CASE("layout_horizontal_reduces_width_by_gap", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_grid_positions_cells", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_dock_top_takes_available_width", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_dock_center_fills_remaining", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_absolute_uses_child_spec_pos", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_hit_test_finds_leaf_widget", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
...
TEST_CASE("layout_mark_dirty_propagates_up", "[ui][layout][wave3]") {
    sao_ui_layout_tree_handle_t tree = nullptr;
    REQUIRE(sao_ui_layout_tree_create(&tree) == SAO_STATUS_OK);
    SaoUiLayoutSpec root_spec{};
    sao_ui_layout_spec_defaults(&root_spec);
