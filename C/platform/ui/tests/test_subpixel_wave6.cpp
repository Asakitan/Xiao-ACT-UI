// Wave 6 / Agent e tests for the overlay_subpixel first slice.
//
...
TEST_CASE("subpixel_snap_or_floor_boundaries", "[ui][subpixel][wave6]") {
...
TEST_CASE("subpixel_composite_integer_offset", "[ui][subpixel][wave6]") {
...
TEST_CASE("subpixel_composite_fractional_shift", "[ui][subpixel][wave6]") {
...
TEST_CASE("subpixel_bar_width_full_int", "[ui][subpixel][wave6]") {
...
TEST_CASE("subpixel_bar_width_fractional_fade", "[ui][subpixel][wave6]") {
