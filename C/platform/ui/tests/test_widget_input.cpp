// Button widget sizing, hit-test, and event-dispatch tests.
//
// Coverage (5 CASE):
...
// ── Button helper API prototypes (not in widget_input.h) ──────────
...
TEST_CASE("button_create_stores_spec_and_text", "[ui][widget][input][runtime]") {
...
TEST_CASE("button_preferred_size_matches_text_and_padding", "[ui][widget][input][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
...
TEST_CASE("button_hit_test_inside_and_outside", "[ui][widget][input][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
...
TEST_CASE("button_dispatch_click_fires_callback_with_action_id", "[ui][widget][input][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
...
TEST_CASE("button_disabled_button_swallows_click", "[ui][widget][input][runtime]") {
    sao_ui_widget_handle_t h = nullptr;
