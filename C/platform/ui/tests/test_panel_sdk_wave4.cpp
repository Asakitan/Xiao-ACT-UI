...
TEST_CASE("panel_registry_count_tracks_registrations", "[ui][panel_sdk][wave4]") {
    size_t base = 0;
...
TEST_CASE("panel_unregister_removes_from_registry", "[ui][panel_sdk][wave4]") {
