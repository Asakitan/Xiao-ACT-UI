// Focused state, layout, reentry, and child-menu tests for the SAO main menu.
//
...
// ── Prototypes for helper APIs implemented in menu.cpp but
...
TEST_CASE("menu_create_ring_mode_layout_correct", "[ui][menu][interpreter]") {
...
TEST_CASE("menu_hit_test_ring_center_returns_no_button", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
    const SaoUiMenuLayout l = make_ring_layout();
...
TEST_CASE("menu_hit_test_ring_button_position_returns_correct_index", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
...
TEST_CASE("menu_show_transitions_to_opening", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
...
TEST_CASE("menu_tick_progresses_to_open_after_450ms", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
...
TEST_CASE("menu_set_button_state_hover_and_query", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
...
TEST_CASE("menu callbacks allow reentry and isolate exceptions", "[ui][menu][interpreter][callback]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
...
TEST_CASE("menu_hide_transitions_to_closing", "[ui][menu][interpreter]") {
    sao_ui_menu_handle_t menu = make_ring_menu();
