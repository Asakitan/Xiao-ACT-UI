// Wave 4 tests for the 3 time-display labels (G3.8 first slice).
//
...
// wave4 formatter APIs (int64/int32/uint64) that only accept the
...
// Wave4 strict-typed formatters (distinct parameter types → compile-time
