// SAO Auto — alerts, TTS, banner, and sound tests.
//
// Coverage:
...
TEST_CASE("alerts_sound_play_missing_file_returns_error",
    ...
    // capability-gate rollout) — NOT_IMPLEMENTED is accepted for older builds.
...
TEST_CASE("alerts_speak_voice_enumeration",
    ...
    // CAPABILITY_MISSING) — accept any.  Windows CI images
