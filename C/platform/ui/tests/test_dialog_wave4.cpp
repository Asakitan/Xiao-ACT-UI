// SAO Auto - Wave4 dialog state machine tests (G3.5 gate).
//
// Covers the state machine documented in dialog.h Wave 4 slice:
...
TEST_CASE("dialog_create_info_kind_2_buttons", "[ui][dialog][wave4]") {
    DialogCtx ctx;
...
TEST_CASE("dialog_show_transitions_to_expanding", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
...
TEST_CASE("dialog_dispatch_tab_advances_focus", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
    int32_t focus = -1;
...
TEST_CASE("dialog_dispatch_shift_tab_reverses_focus", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
...
TEST_CASE("dialog_dispatch_enter_returns_button_result", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
...
TEST_CASE("dialog_dispatch_escape_returns_cancel", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
...
TEST_CASE("dialog_dismiss_transitions_to_shrinking", "[ui][dialog][wave4]") {
    DialogCtx ctx;
    auto* h = make_info_two_buttons(ctx);
