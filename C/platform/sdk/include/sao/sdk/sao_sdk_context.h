...
enum sao_sdk_ui_widget_kind_e : int32_t {
    ...
    SAO_SDK_UI_WIDGET_RADIO = 10,
    SAO_SDK_UI_WIDGET_SLIDER = 11,
    SAO_SDK_UI_WIDGET_DROPDOWN = 12,
    SAO_SDK_UI_WIDGET_SCROLLBAR = 13,
    SAO_SDK_UI_WIDGET_METRIC = 14,
    SAO_SDK_UI_WIDGET_EMPTY_STATE = 15,
    SAO_SDK_UI_WIDGET_TREE_VIEW = 16,
    SAO_SDK_UI_WIDGET_BAR_CHART = 17,
    SAO_SDK_UI_WIDGET_LINE_CHART = 18,
    SAO_SDK_UI_WIDGET_SPARKLINE = 19,
    SAO_SDK_UI_WIDGET_SCRIPTABLE_CANVAS = 20,
};
