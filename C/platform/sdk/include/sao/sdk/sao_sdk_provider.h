...
#define SAO_SDK_PROVIDER_ABI_VERSION                                                               \
    ((SAO_SDK_PROVIDER_ABI_VERSION_MAJOR << 16) | SAO_SDK_PROVIDER_ABI_VERSION_MINOR)
...
typedef void(SAO_SDK_CALL* sao_sdk_timer_callback_t)(sao_sdk_timer_token_t timer, void* user_data);

typedef void(SAO_SDK_CALL* sao_sdk_dialog_callback_t)(sao_sdk_dialog_token_t dialog,
...
struct SaoSdkProviderVTable {
    ...
    sao_sdk_status_t(SAO_SDK_CALL* tts_speak)(void* user_data, const char* text_utf8, float volume,
                                              float rate);
    sao_sdk_status_t(SAO_SDK_CALL* tts_stop)(void* user_data);

    sao_sdk_status_t(SAO_SDK_CALL* register_render_hook)(void* user_data,
                                                         const char* plugin_id_utf8,
                                                         int32_t hook_point,
                                                         sao_sdk_render_hook_callback_t callback,
                                                         void* callback_user_data,
                                                         uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* unregister_render_hook)(void* user_data,
                                                           uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* register_timer)(void* user_data, uint32_t interval_ms,
                                                   sao_sdk_timer_callback_t callback,
                                                   void* callback_user_data,
                                                   uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* unregister_timer)(void* user_data, uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* register_hotkey)(void* user_data, const char* plugin_id_utf8,
                                                    const char* binding_id_utf8,
                                                    uint32_t virtual_key, uint32_t modifiers,
                                                    sao_sdk_hotkey_callback_t callback,
                                                    void* callback_user_data,
                                                    uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* unregister_hotkey)(void* user_data, uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* show_dialog)(void* user_data, const char* plugin_id_utf8,
                                                const struct SaoSdkDialogSpec* spec,
                                                sao_sdk_dialog_callback_t callback,
                                                void* callback_user_data,
                                                uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* dismiss_dialog)(void* user_data, uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* show_notify)(void* user_data, const char* plugin_id_utf8,
                                                const struct SaoSdkNotifySpec* spec,
                                                uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* dismiss_notify)(void* user_data, uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* set_overlay)(void* user_data, const char* plugin_id_utf8,
                                                const struct SaoSdkOverlaySpec* spec,
                                                uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* clear_overlay)(void* user_data, uint64_t provider_token);

    sao_sdk_status_t(SAO_SDK_CALL* register_render_hook_ex)(void* user_data,
                                                            const char* plugin_id_utf8,
                                                            const struct SaoSdkRenderHookSpec* spec,
                                                            sao_sdk_render_hook_callback_t callback,
                                                            void* callback_user_data,
                                                            uint64_t* out_provider_token);
    sao_sdk_status_t(SAO_SDK_CALL* request_redraw)(void* user_data, const char* surface_id_utf8);
    ...
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_open_session)(void* user_data,
                                                          const char* plugin_id_utf8,
                                                          void** out_session);
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_close_session)(void* user_data, void* session);
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_attach)(void* user_data, void* session, uint32_t pid);
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_detach)(void* user_data, void* session);
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_enum_regions)(void* user_data, void* session,
                                                          struct SaoSdkGpuHuntRegion* out_regions,
                                                          size_t capacity, size_t* out_count);
    sao_sdk_status_t(SAO_SDK_CALL* gpu_hunt_read)(void* user_data, void* session, uint64_t address,
...
// Configures the process-wide GPU-hunt I/O owner used by contexts bound with
// sao_sdk_context_bind_platform_services().  The SDK retains the provider
// while configured and takes an additional retain/release lease for every
// open tracker session.  Passing null removes the owner for future sessions;
// sessions already opened keep their provider alive until close.
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL
sao_sdk_platform_gpu_hunt_configure_provider(const struct SaoSdkProviderVTable* provider);
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_platform_render_dispatch(
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_platform_render_gpu_provider_status(void);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL
sao_sdk_context_provider_status(const struct SaoSdkContext* ctx);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_timer_register(const struct SaoSdkContext* ctx,
                                                                 uint32_t interval_ms,
                                                                 sao_sdk_timer_callback_t callback,
                                                                 void* user_data,
                                                                 sao_sdk_timer_token_t* out_timer);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_timer_unregister(const struct SaoSdkContext* ctx,
                                                                   sao_sdk_timer_token_t timer);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_dialog_show(const struct SaoSdkContext* ctx,
                                                              const struct SaoSdkDialogSpec* spec,
                                                              sao_sdk_dialog_callback_t callback,
                                                              void* user_data,
                                                              sao_sdk_dialog_token_t* out_dialog);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_dialog_dismiss(const struct SaoSdkContext* ctx,
                                                                 sao_sdk_dialog_token_t dialog);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_notify_show(const struct SaoSdkContext* ctx,
                                                              const struct SaoSdkNotifySpec* spec,
                                                              sao_sdk_notify_token_t* out_notify);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_notify_dismiss(const struct SaoSdkContext* ctx,
                                                                 sao_sdk_notify_token_t notify);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_overlay_set(const struct SaoSdkContext* ctx,
                                                              const struct SaoSdkOverlaySpec* spec,
