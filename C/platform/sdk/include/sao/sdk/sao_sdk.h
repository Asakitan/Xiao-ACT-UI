...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_context_create(const char* base_dir_utf8,
...
// owned by the caller and the function may be retried.
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_context_try_destroy(struct SaoSdkContext* ctx);
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_bind_context(const char* plugin_id_utf8,
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL
sao_sdk_panel_update_widget(const struct SaoSdkContext* ctx, sao_sdk_ui_panel_t panel,
                            sao_sdk_ui_widget_t widget, const struct SaoSdkWidgetSpec* widget_spec);
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_request_redraw(const struct SaoSdkContext* ctx,
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_unsubscribe_event(const struct SaoSdkContext* ctx,
                                                                    sao_sdk_subscription_t handle);

SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_publish_event(const struct SaoSdkContext* ctx,
...
SAO_SDK_API sao_sdk_status_t SAO_SDK_CALL sao_sdk_unregister_hotkey(const struct SaoSdkContext* ctx,
