# -*- coding: utf-8 -*-
"""
SAOMenuLeftStack — left-column stack containing SAOPlayerPanel and
SAOSessionPlayersPanel, with show/hide animation for the session list.

Extracted from sao_gui.py (round 28 of the split refactor).
"""
