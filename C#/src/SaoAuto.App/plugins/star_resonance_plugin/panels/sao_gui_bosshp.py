...
from plugins.star_resonance_plugin.panels.sao_gui_dps import (  # noqa: F401
...
class BossHpOverlay:
    ...
    def destroy(self) -> None:
        ...
        # Destroy the window before dropping the presenter to avoid a
        # render callback hitting a half-released object during close.
