...
public sealed class ActBridge : IDisposable
{
    ...
    [
        ...
        BridgeCommands.ActMemStatus,
        BridgeCommands.ActMemCatalog,
        BridgeCommands.ActMemSelf,
        BridgeCommands.ActMemEntities,
        BridgeCommands.ActMemBoss,
        BridgeCommands.ActMemBossActions,
        BridgeCommands.ActMemBossAction,
        BridgeCommands.ActMemDamage,
        BridgeCommands.ActMemSkillDamage,
        BridgeCommands.ActMemAttrMap,
        BridgeCommands.ActMemResolveName,
        BridgeCommands.ActMemRead,
        BridgeCommands.ActMemReadMany,
        BridgeCommands.ActMemSearch,
        BridgeCommands.ActMemSearchStatus,
        BridgeCommands.ActMemNarrow,
        BridgeCommands.ActMemSearchCancel,
        BridgeCommands.ActMemSearchList,
        ...
        BridgeCommands.ActTriggerExportPresets,
        BridgeCommands.ActTriggerImportPresets,
        BridgeCommands.ActTriggersExportPresets,
        BridgeCommands.ActTriggersImportPresets,
    ];
